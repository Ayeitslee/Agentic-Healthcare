...
Security: Modeled after CampusGenAI, this architecture is designed for a private, encrypted environment where Protected Health Information (PHI) is tokenized before processing [History].
